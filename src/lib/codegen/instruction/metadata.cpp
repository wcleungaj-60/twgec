...
DefaultMap metadata::ConfigSetup::defaultMap = DefaultMap(
    {
        ...
        {keyword::metadataKind::bornLockDuration, {AST_INT, CODEGEN_INT, "100"}},
        {keyword::metadataKind::minPlayers, {AST_INT, CODEGEN_INT, "1"}},
        {keyword::metadataKind::supportSignin, {AST_BOOL, CODEGEN_BOOL, "true"}},
        {keyword::metadataKind::mustLogin, {AST_BOOL, CODEGEN_BOOL, "true"}},
        {keyword::metadataKind::allowGuest, {AST_BOOL, CODEGEN_BOOL, "true"}},
        {keyword::metadataKind::supportMsgServer, {AST_BOOL, CODEGEN_BOOL, "true"}},
        ...
        {keyword::metadataKind::setInitFocus, {AST_BOOL, CODEGEN_BOOL, "false"}},
        {keyword::metadataKind::setBornDuration, {AST_BOOL, CODEGEN_BOOL, "false"}},
        {keyword::metadataKind::nextGameEnabled, {AST_BOOL, CODEGEN_BOOL, "true"}},
        {keyword::metadataKind::playDefaultMusic, {AST_BOOL, CODEGEN_BOOL, "true"}},
        {keyword::metadataKind::disableNextGameOnMissionComplete,
         {AST_BOOL, CODEGEN_BOOL, "false"}},
        {keyword::metadataKind::useDefaultItems, {AST_BOOL, CODEGEN_BOOL, "false"}},
        {keyword::metadataKind::defCarryItems, {AST_BOOL, CODEGEN_BOOL, "false"}},
        {keyword::metadataKind::useDefaultCampLocs,
         {AST_BOOL, CODEGEN_BOOL, "false"}},
        {keyword::metadataKind::useCustomWeapons, {AST_BOOL, CODEGEN_BOOL, "false"}},
        ...
        {keyword::metadataKind::useCustomFarWeapons,
         {AST_BOOL, CODEGEN_BOOL, "false"}},
        {keyword::metadataKind::useCustomItems, {AST_BOOL, CODEGEN_BOOL, "false"}},
        {keyword::metadataKind::title, {AST_STRING, CODEGEN_STRING, "我的任務"}},
...
void metadata::ConfigSetup::setup(
  ...
  of << inden(4) << "\"$schema\": " << defaultMap.get(keyword::metadataKind::schema)
     << "," << std::endl;
  ...
  of << inden(16) << "\"title\": " << defaultMap.get(keyword::metadataKind::title)
     << "," << std::endl;
  ...
  of << inden(20)
     ...
     << std::endl;
  of << inden(20)
     << "\"supportSignin\": " << defaultMap.get(keyword::metadataKind::supportSignin)
     << "," << std::endl;
  of << inden(20)
  ...
  of << inden(20) << "\"supportMsgServer\": "
     << defaultMap.get(keyword::metadataKind::supportMsgServer) << "," << std::endl;
  of << inden(20)
     << "\"gamezoneCode\": " << defaultMap.get(keyword::metadataKind::gamezoneCode)
     << "," << std::endl;
  ...
  of << inden(16) << "\"runGame\": " << defaultMap.get(keyword::metadataKind::runGame)
     << "," << std::endl;
  of << inden(16) << "\"gameStartFadein\": \"fadein\"," << std::endl;
  of << inden(16) << "\"lives\": " << defaultMap.get(keyword::metadataKind::lives)
     << "," << std::endl;
  of << inden(16) << "\"debugCamp\": \"ask\"," << std::endl;
  of << inden(16) << "\"releaseCamp\": \"ask\"," << std::endl;
  of << inden(16)
     << "\"setInitFocus\": " << defaultMap.get(keyword::metadataKind::setInitFocus)
     << "," << std::endl;
  ...
  of << inden(20)
     << "\"campOpSkydow\": " << defaultMap.get(keyword::metadataKind::campOpSkydow)
     << "," << std::endl;
  of << inden(20)
     << "\"campOpRoyal\": " << defaultMap.get(keyword::metadataKind::campOpRoyal)
     << "," << std::endl;
  of << inden(20)
     << "\"campOpThird\": " << defaultMap.get(keyword::metadataKind::campOpThird)
     << std::endl;
  of << inden(16) << "}," << std::endl;
  of << inden(16) << "\"map\": " << defaultMap.get(keyword::metadataKind::map) << ","
     << std::endl;
  of << inden(16) << "\"maxAbilityLevel\": "
     << defaultMap.get(keyword::metadataKind::maxAbilityLevel) << "," << std::endl;
  of << inden(16) << "\"nextGameEnabled\": "
     << defaultMap.get(keyword::metadataKind::nextGameEnabled) << "," << std::endl;
  ...
  of << inden(16) << "\"playDefaultMusic\": "
     << defaultMap.get(keyword::metadataKind::playDefaultMusic) << "," << std::endl;
  of << inden(16) << "\"cameraAfterOver\": \"restrict\"," << std::endl;
  of << inden(16) << "\"useDefaultItems\": "
     << defaultMap.get(keyword::metadataKind::useDefaultItems) << "," << std::endl;
  of << inden(16) << "\"useDefaultCampLocs\": "
     << defaultMap.get(keyword::metadataKind::useDefaultCampLocs) << "," << std::endl;
  of << inden(16)
  ...
  of << inden(16) << "\"useCustomWeapons\": "
     << defaultMap.get(keyword::metadataKind::useCustomWeapons) << "," << std::endl;
  of << inden(16) << "\"customWeapons\": " << customWeaponsNode.to_string(16)
     << "," << std::endl;
  of << inden(16) << "\"useCustomItems\": "
     << defaultMap.get(keyword::metadataKind::useCustomItems) << "," << std::endl;
